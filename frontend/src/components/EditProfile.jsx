...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
       ...
       if(input.profilePhoto){
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://insta-clone-5she.onrender.com/api/v1/user/profile/edit', formData,{
                headers:{
            ...
            if(res.data.success){
                const updatedUserData ={
                    ...
                    profillePicture: res.data.user?.profilePicture,
                ...
                <div className='flex justify-end'>
                    {
                        loading ? (
                            ...
                            <Button onClick={editProfileHandler} className='w-fit bg-[#0095F6] hover:bg-[#2aBccd]'>Submit</Button>
                        )
                    }
                </div>
            </section>
