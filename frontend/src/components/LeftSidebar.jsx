...
const LeftSidebar = () => {
    ...
    const logoutHandler = async () => {
        try {
            const res = await axios.get('https://insta-clone-5she.onrender.com/api/v1/user/logout',
                                    ...
                                    <span>{item.text}</span>
                                    {
                                        item.text == "Notifications" && likeNotification.length > 0 && (
                                            <Popover>
                                               ...
                                               <Button size='icon' className="rounded-full h-6 w-5 bg-red-600 hover:bg-red-600 absolute bottom-6 left-6">{likeNotification.length}</Button>
                                                </PopoverTrigger>
